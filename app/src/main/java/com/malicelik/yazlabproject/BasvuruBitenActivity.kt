...
import com.malicelik.yazlabproject.databinding.ActivityBasvuruBitenBinding


class BasvuruBitenActivity : AppCompatActivity(),RecyclerAdapter.MyOnclickListener {
    lateinit var binding: ActivityBasvuruBitenBinding
    private lateinit var dbref:DatabaseReference
    private  lateinit var pdfRecyclerView: RecyclerView
    private var PdfList = ArrayList<Pdf>()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBasvuruBitenBinding.inflate(layoutInflater)
        ...
        val adapter = RecyclerAdapter(PdfList,this@BasvuruBitenActivity,2)
        ...
        dbref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                if(snapshot.exists()){
                    ...
                    pdfRecyclerView.adapter=RecyclerAdapter(PdfList,this@BasvuruBitenActivity,2)
                }
            }
